...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2026 at 11:59 AM
...
INSERT INTO `products` (`id`, `category_id`, `name`, `slug`, `short_description`, `long_description`, `price_min`, `price_max`, `material`, `height`, `weight`, `finish`, `product_usage`, `origin`, `care_instructions`, `availability`, `delivery_in_stock`, `delivery_custom`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'Marble Buddha Statue', 'marble-sitting-buddha-statue', 'Beautiful handcrafted white marble Buddha statue', 'This exquisite Marble Sitting Buddha Statue is meticulously handcrafted by skilled artisans from Rajasthan.', 9000.00, 15000.00, 'Premium White Makrana Marble', '18 Inches (Standard) | Custom sizes available', '12 kg (Approx)', 'Hand Polished to High Gloss', 'Indoor & Outdoor', 'Rajasthan, India', 'Wipe with soft cloth, avoid harsh chemicals', 'both', '5-7 business days', '15-20 days', 1, '2026-01-02 15:49:31', '2026-01-02 16:01:41');
...
(2, 1, 'slider2.jpg', 0, 2, '2026-01-02 15:53:16'),
